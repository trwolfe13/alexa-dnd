...
export class LevelIntentHandler extends IntentHandler {
  get intents(): IntentMap {
    return {
      LevelsAbsoluteExperienceIntent: this.absoluteExperience,
      LevelsRelativeExperienceIntent: this.relativeExperience,
      LevelsProficiencyIntent: this.proficiencyBonus,
    };
  }
